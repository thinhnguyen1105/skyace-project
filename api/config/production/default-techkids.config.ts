const defaultConfig = {
  ...
  nextjs: {
    apiUrl: 'https://skyace.techkids.io/api',
    tenantUrl: 'http://<%tenant%>.skyace.techkids.io',
    hostUrl: 'https://skyace.techkids.io',
    tailUrl : '.skyace.techkids.io',
    checkUrlRegex: /https?:\/\/(\S*\.)?skyace.techkids.io/,
    checkUrlRegexFrontEnd: /(\S*\.)?skyace.techkids.io/,
    cookieDomain: '.skyace.techkids.io',
    corsOrigin: /.*\.skyace.techkids.io$/,
