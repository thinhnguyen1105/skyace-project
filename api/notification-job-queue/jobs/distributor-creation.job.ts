...
const processingDistributorCreationEmail = (jobInfo, done) => {
  const transporter = initNodeMailer();
  
  ejs.renderFile(path.join(__dirname + `../../../../../../static/email-template/distributor-registration.ejs`), {
...
export {
  processingDistributorCreationEmail,
};