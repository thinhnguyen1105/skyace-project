const defaultConfig = {
  ...
  nextjs: {
    apiUrl: 'https://demo-skyace.com/api',
    tenantUrl: 'http://<%tenant%>.demo-skyace.com',
    hostUrl: 'https://demo-skyace.com',
    tailUrl : '.demo-skyace.com',
    checkUrlRegex: /https?:\/\/(\S*\.)?demo-skyace.com/,
    checkUrlRegexFrontEnd: /(\S*\.)?demo-skyace.com/,
    cookieDomain: '.demo-skyace.com',
    corsOrigin: /.*\.demo-skyace.com$/,
