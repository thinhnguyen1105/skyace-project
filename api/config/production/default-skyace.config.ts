const defaultConfig = {
  ...
  nextjs: {
    apiUrl: 'https://skyace-learning.com/api',
    tenantUrl: 'http://<%tenant%>.skyace-learning.com',
    hostUrl: 'https://skyace-learning.com',
    tailUrl : '.skyace-learning.com',
    checkUrlRegex: /https?:\/\/(\S*\.)?skyace-learning.com/,
    checkUrlRegexFrontEnd: /(\S*\.)?skyace-learning.com/,
    cookieDomain: '.skyace-learning.com',
    corsOrigin: /.*\.skyace-learning.com$/,
